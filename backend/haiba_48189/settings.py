"""
Django settings for haiba_48189 project.
...
WSGI_APPLICATION = 'haiba_48189.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "haiba_48189 API",
    "DESCRIPTION": "API documentation for haiba_48189 App",
    "VERSION": "v1",
}
